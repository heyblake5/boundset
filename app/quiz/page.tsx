  ...
  return (
    <>
      <style>{`
        ...
        .ql-logo{display:flex;align-items:center;text-decoration:none}
        ...
        .ql-sub{font-size:clamp(16px,2vw,19px);color:#4a4a4a;max-width:520px;line-height:1.65;margin-bottom:36px;font-weight:300}
      ...
      <div className="ql">
        ...
        <div className="ql-sec">
          <p className="ql-sube">How it works</p>
          <h2>Five dimensions, one score,<br />and a real plan to fix it</h2>
          <p className="ql-ssub">The quiz covers message clarity, market positioning, value communication, sales efficiency, and internal alignment — the five places where positioning breaks down most for B2B SaaS companies, and most founders finish in under 5 minutes.</p>
        ...
        <div className="ql-pain">
          <div className="ql-pi">
            <p className="ql-sube">What changes</p>
            <h2>What positioning can change<br />for your company</h2>
            <p className="ql-ssub">The gap between a company with strong positioning and one without shows up in every part of the business, from how fast deals close to how confidently your team talks about the product.</p>
            <div className="ql-cmp">
              <div>
        ...
        <div className="ql-fin">
          <h2>Find out where you stand <i style={{fontFamily:'Playfair Display,serif',color:'#2d6a4a'}}>right now</i></h2>
          <p>Free, done in under 6 minutes, and specific enough that you will know exactly what to fix before the week is out.</p>
          <a href="/quiz/score" className="ql-btn" style={{margin:'0 auto'}}>Get your positioning score →</a>
          <p className="ql-cs">No pitch · No pressure · Your results are yours to keep</p>
        </div>
      ...
      <script dangerouslySetInnerHTML={{__html:`
        window.addEventListener('scroll',function(){
          var n=document.getElementById('qnav');
          if(n){if(window.scrollY>20)n.classList.add('sc');else n.classList.remove('sc');}
        });
      `}}/>
    </>
  );
